...
![StreamPipes Login](/img/features_new/login.png) 
...
<div class="my-carousel">
    <img src="/img/features_new/home/home.png" alt="Home">
    <img src="/img/features_new/home/open_menu.png" alt="Open Menu">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/editor/2_PipelineEditor_DataStreams.png" alt="Data Streams">
    <img src="/img/features_new/editor/3_PipelineEditor_DataProcessors.png" alt="Processing Elements">
    <img src="/img/features_new/editor/4_PipelineEditor_DataSinks.png" alt="Data Sinks">
    <img src="/img/features_new/editor/1_PipelineEditor_DataSets.png" alt="Data Sets">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/editor/5_text_filter.png" alt="Text Filter">
    <img src="/img/features_new/editor/6_category_drop_down.png" alt="Category Drop Down">
    <img src="/img/features_new/editor/7_category_filter.png" alt="Category Filter">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/editor/8_connect_elements.png" alt="Connect Elements">
    <img src="/img/features_new/editor/9_configure_element.png" alt="Configure Elements">
</div>
...
![Connection Error](/img/features_new/editor/10_connection_error.png) 
...
<div class="my-carousel">
    <img src="/img/features_new/editor/11_shortcut_buttons.png" alt="Shortcut Buttons">
    <img src="/img/features_new/editor/12_compatible_elements.png" alt="Compatible Elements">
    <img src="/img/features_new/editor/13_recommend_elements.png" alt="Recommended elements">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/editor/14_save_adjust.png" alt="Save adjust delete">
    <img src="/img/features_new/editor/15_save_dialogue.png" alt="Complete pipeline">
    <img src="/img/features_new/editor/16_pipeline_sucessfully_started.png" alt="Pipeline sucessfully started">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/manage_pipelines/1_pipeline_overview.png" alt="Pipeline Overview">
    <!-- <img src="/img/features_new/manage_pipelines/2_start_stop_pipeline.png" alt="Start stop Pipelines"> -->
     <img src="/img/features_new/editor/17_pipeline_information.png" alt="Pipeline infomation">
    <img src="/img/features_new/manage_pipelines/3_delete_pipeline.png" alt="Delete Pipelines">
    <img src="/img/features_new/manage_pipelines/4_pipeline_deleted.png" alt="Delete Pipelines">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/manage_pipelines/5_pipeline_category.png" alt="Pipeline Category">
    <img src="/img/features_new/manage_pipelines/6_add_category.png" alt="Add Pipeline Category">
    <img src="/img/features_new/manage_pipelines/7_new_category.png" alt="New Category">
    <img src="/img/features_new/manage_pipelines/8_show_new_category.png" alt="Show new Category">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/dashboard/01_dashboard.png" alt="Screenshot of live dashboard">
    <!-- <img src="/img/features_new/dashboard/06_add_new.png" alt="New Visualization"> -->
    <img src="/img/features_new/dashboard/02_new_visualisation.png" alt="Select Pipeline to visualize">
    <img src="/img/features_new/dashboard/03_select_gauge.png" alt="Select Visualization Type">
    <img src="/img/features_new/dashboard/04_configure_gauge.png" alt="Configure  Visualzation">
    <img src="/img/features_new/dashboard/05_new_gauge_done.png" alt="Show new Visualzation">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/file_download/01_file_download.png" alt="File Download">
    <img src="/img/features_new/file_download/02_file_download.png" alt="File Download with selected time range">
    <img src="/img/features_new/file_download/03_file_download.png" alt="File Download with new File">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/notification/01_select_notification_sink.png" alt="Select Notification">
    <img src="/img/features_new/notification/02_configure_notification.png" alt="Configure Notification">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/notification/04_new_notification.png" alt="New Notification">
    <!-- <img src="/img/features_new/notification/05_mark_read.png" alt="Mark Notification as read">
    <img src="/img/features_new/notification/06_marked_as_read.png" alt="Notification read">
    <img src="/img/features_new/notification/07_Notifications_SubPage.png" alt="Notification Subpage"> -->
...
<div class="my-carousel">
    <img src="/img/features_new/install_elements/01_install_elements.png" alt="Install Elements View">
    <img src="/img/features_new/install_elements/02_install_countAggregation.png" alt="Insall new Element">
    <img src="/img/features_new/install_elements/03_installed_countAggregation.png" alt="Installation Successful">
    <img src="/img/features_new/install_elements/04_countAggregation_in_editor.png" alt="Show new installed element">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/my_elements/01_my_elements.png" alt="My Elements Overview">
    <img src="/img/features_new/my_elements/02_my_elements_jsonid.png" alt="View JSON-LD">
</div>
...
<div class="my-carousel">
    <img src="/img/features_new/configuration/01_configuration_overview.png" alt="Configuration Overview">
    <img src="/img/features_new/configuration/02_change_config.png" alt="Change Configuration">
</div>
